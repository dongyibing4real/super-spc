...
export const INDIVIDUAL_ONLY: Set<string> = new Set(["imr", "mr", "levey_jennings", "run", "g", "t"]);

/** Chart types that require a subgroup column. */
export const SUBGROUP_REQUIRED: Set<string> = new Set([
  "xbar_r", "xbar_s", "r", "s",
  "p", "np", "c", "u", "laney_p", "laney_u",
  "three_way", "presummarize",
]);

export const SIGMA_METHOD_LABELS: Record<string, string> = {
